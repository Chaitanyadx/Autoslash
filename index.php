      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="car-listing.php" class="btn">Book A Car <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<div class="recent-car-list carListing">
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive carLIstingImg" alt="image"></a>
<ul>
...
{  ?>
        ...
        <div class="testimonial-m" style="height: 30rem;">
